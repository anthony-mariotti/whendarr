...
<p align="center">
  ...
  <a title="Crowdin" target="_blank" href="https://crowdin.com/project/whendarr"><img src="https://badges.crowdin.net/whendarr/localized.svg" alt="Crowdin"></a>
</p>
...
4. Run linting (`pnpm lint && pnpm test`)
5. Open a PR
